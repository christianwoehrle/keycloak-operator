...
func schema_pkg_apis_keycloak_v1alpha1_KeycloakSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"resources": {
						SchemaProps: spec.SchemaProps{
							Description: "Specify resources",
							Ref:         ref("./pkg/apis/keycloak/v1alpha1.ResourceRequirements"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/keycloak/v1alpha1.KeycloakExternalAccess", "./pkg/apis/keycloak/v1alpha1.KeycloakExternalDatabase", "./pkg/apis/keycloak/v1alpha1.PodDisruptionBudgetConfig", "./pkg/apis/keycloak/v1alpha1.ResourceRequirements"},
	}
}
